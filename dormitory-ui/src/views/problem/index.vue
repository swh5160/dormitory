  ...
  <div class="app-container">
    ...
    >
      ...
      <template slot="menu" slot-scope="{row,index}">
        ...
        <el-button v-if="roles.includes('ADMIN')&&!row.pass" type="text"
                   icon="el-icon-edit" @click="handlePass(row, index)">审核
        </el-button>
        <el-button v-if="roles.includes('STUDENT')&&!row.pass&&(row.studentId===user.id)" type="text"
                   icon="el-icon-edit" @click="handleUpdate(row, index)">编辑
        </el-button>
        <el-button type="text" icon="el-icon-delete" v-if="roles.includes('STUDENT')&&(row.studentId===user.id)"
                   @click="handleDel(row,index)">删除
        </el-button>
        <el-button type="text" icon="el-icon-delete" v-if="roles.includes('ADMIN')"
                   @click="handleDel(row,index)">删除
        </el-button>
      </template>
    </avue-crud>
...
<script>
import { audit, deleteById, getPage, saveOrUpdate } from '@/api/problem'
